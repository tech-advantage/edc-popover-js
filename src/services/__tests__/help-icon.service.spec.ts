...
import { EdcPopoverOptions, IconConfig, IEdcPopoverOptions, PopoverIcon } from '../../class';
import {
    DARK_CLASS_NAME,
    DEFAULT_ICON,
    ERROR_ICON,
...
import { IconBehavior } from '../../class/fail-behavior';

describe('HelpIcon service test', () => {
    ...
    describe('buildIconClasses', () => {
        ...
        it('should add the dark class', () => {
            ...
            expect(classes).toContain('my-custom-icon-class');
            expect(classes).toContain(DARK_CLASS_NAME);
        });
        it('should include the url image class', () => {
            ...
            expect(classes).toContain(DARK_CLASS_NAME);
            expect(classes).toContain(IMAGE_CLASS_NAME);
        });
